...
pipeaccess_library_init(const GDExtensionInterface *p_interface,
  ...
  // initialization.
  init_obj.register_initializer(initialize_pipeaccess_module);
  init_obj.register_terminator(uninitialize_pipeaccess_module);
