...
const RunningGameCard := preload("res://core/ui/card_ui/navigation/running_game_card.gd")
const running_card_scene := preload("res://core/ui/card_ui/navigation/running_game_card.tscn")
...
var menu_focus := preload("res://core/ui/card_ui/main-menu/main_menu_focus.tres") as FocusStack
