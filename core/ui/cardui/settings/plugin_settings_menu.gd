...
const settings_content_scene := preload("res://core/ui/cardui/settings/plugin_settings_content.tscn")
...
func _config_settings_menu(plugin_settings: Control, plugin_content_container: Control) -> void:
	...
	plugin_focus_group.focus_stack = load("res://core/ui/cardui/settings/settings_menu_focus.tres")
