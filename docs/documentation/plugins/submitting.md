...
!!! warning
    ...
    Please be aware that we do not allow private repositories, "black-box"
    binaries, deliberately obfuscated code or any other items that would
    undermine the ability to verify the functionality of a plugin and or any
    underlying software.
